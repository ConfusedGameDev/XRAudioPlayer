...
Shader "S_CoverFlow_CustomUV"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = tex2D( _TextureSample0, uv_TexCoord6 ).rgb;
			o.Alpha = _Opacity;
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-464,208;Inherit;False;Property;_Opacity;Opacity;1;0;Create;True;1;Opacity;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
